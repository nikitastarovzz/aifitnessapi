...
export function GET() {
  ...
  add("/healthkit-identifiers", "Every HealthKit Quantity Type Identifier", "All 120 HKQuantityTypeIdentifier values with unit family, iOS availability, and the cumulative-vs-discrete split.", "healthkit hkquantitytypeidentifier cumulative discrete hkstatisticsquery units identifiers");
