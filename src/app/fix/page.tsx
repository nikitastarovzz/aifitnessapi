...
const GROUPS: { title: string; blurb: string; slugs: string[] }[] = [
  {
    ...
    slugs: ["fitbit-error-code-401", "strava-api-401-unauthorized", "fitness-api-401-unauthorized", "oauth-redirect-uri-mismatch", "refresh-token-not-working", "oura-personal-access-token-deprecated"],
  },
  {
    title: "Rate limits",
...
export default function FixPillar() {
  ...
  return (
    <Container className="py-14">
      <HubJsonLd basePath="/fix" description={String(metadata.description)} />
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <ClusterHero label="Troubleshooting" seed={heroSeed(FIX_PATH)} />
