...
export default function LearnPillar() {
  ...
  return (
    <Container className="py-14">
      <HubJsonLd basePath="/learn" description={String(metadata.description)} />
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <ClusterHero label="Concepts" seed={heroSeed(LEARN_PATH)} />

        <h1 className="text-4xl font-bold leading-tight tracking-tight text-[var(--fg)] sm:text-5xl">
          Fitness &amp; Health API Concepts, Explained
        </h1>

        <HubFreshness entries={released} basePath={LEARN_PATH} />
