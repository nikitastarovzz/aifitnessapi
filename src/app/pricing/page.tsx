...
import { getPricing, releasedPricing, PRICING_PATH, PRICING_CONFIG } from "@/data/pricing";
...
const QUESTION_COUNT = releasedPricing().reduce((n, e) => n + e.faqs.length, 0);
  ...
  return (
    <Container className="py-14">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <HubFreshness entries={released} basePath={PRICING_PATH} />
        ...
        <section className="mt-14">
          ...
          <p className="mt-6 text-sm text-[var(--muted)]">
            <Link href="/questions/pricing" className="text-brand-600 hover:text-brand-500">
              All {QUESTION_COUNT} questions in {PRICING_CONFIG.hubLabel}, answered
            </Link>
          </p>
        </section>
